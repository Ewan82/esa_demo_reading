...
!     fapar_retrieval
!
!> @brief Implementation of FAPAR target retrieval processor
!
...
!> \date    February 2018
!
subroutine fapar_retrieval(n, x, xcov)
  use mo_sensimul
  ...
  !   (however, FAPAR will only be simulated at S1 acquisition times)
  m = get_npts()
...
end subroutine fapar_retrieval
